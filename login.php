        ...
        <nav id="menu-utama" class="navbar navbar-inverse navbar-static-top" role="complementary">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand navbar-menu" href="#"><i class="glyphicon glyphicon-send"> </i> Voting STMIK</a>
                </div>
                ...
                <div class="panel panel-default"><div class="panel-body">
                    <div class="text-center"><h4>Login Area</h4></div>
                        <form method="post" action="conf/cek.login.php">
                          ...
                          <p><small style="color:#999;">Username: Nomor Induk Mahasiswa</small></p>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Untuk dapat menggunakan Aplikasi E-Voting ini silahkan login terlebih dahulu pada form yang sudah disediakan!. Untuk informasi lebih lanjut silahkan hubungi ADMIN. </p>
              </div>
