        ...
        <div class="container isi">
            <div class="row">
                <div class="col-md-3 menu">
                    ...
                    <a href="?hal=polling" class="list-group-item tombol <?php $_GET['hal']=='polling' ? active : null ;?>">Polling </a>
                    <?php elseif($_SESSION['level'] == "mahasiswa"):?>
                    <a href="?hal=profile" class="list-group-item tombol <?php $_GET['hal']=='polling' ? active : null ;?>">My Profile </a>
                    <a href="?hal=voting" class="list-group-item tombol <?php $_GET['hal']=='polling' ? active : null ;?>">Voting </a>
                    <?php endif;?>
                </div>
